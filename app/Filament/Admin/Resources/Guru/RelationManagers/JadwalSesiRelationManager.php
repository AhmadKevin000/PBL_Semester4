...
namespace App\Filament\Admin\Resources\Guru\RelationManagers;
        ...
        return $table
            ...
            ->actions([
                Actions\ViewAction::make()
                    ->url(fn (SesiKelas $record) => \App\Filament\Admin\Resources\AbsensiGuru\AbsensiGuruResource::getUrl('view', ['record' => $record->absensiGuru?->id ?? 0]))
                ...
                Actions\Action::make('check_in')
                    ...
                    ->color('success')
                    ->url(fn (SesiKelas $record) => \App\Filament\Admin\Resources\AbsensiGuru\AbsensiGuruResource::getUrl('view', ['record' => $record->id ?? 0]))
                    ->visible(fn (SesiKelas $record) => $record->absensiGuru === null),
            ])
            ->bulkActions([
                //
